...
\r
  ...
  <!-- <p class="read-the-docs">Click on the Vite logo to learn more</p> -->\r
</div>\r
`,p=d.replace("VITE_LOGO_PLACEHOLDER",l).replace("JS_LOGO_PLACEHOLDER",s);document.querySelector("#app").innerHTML=p;a(document.querySelector("#counter"));
