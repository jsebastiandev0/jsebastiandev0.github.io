...
`,u=d.replace("VITE_LOGO_PLACEHOLDER",l).replace("JS_LOGO_PLACEHOLDER",s);document.querySelector("#app").innerHTML=u;a(document.querySelector("#counter"));
