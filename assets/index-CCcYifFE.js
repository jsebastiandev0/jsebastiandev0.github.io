...
`,d=u.replace("VITE_LOGO_PLACEHOLDER",l).replace("JS_LOGO_PLACEHOLDER",s);document.querySelector("#app").innerHTML=d;a(document.querySelector("#counter"));
